...
------------------------------ INSERT RULE
INSERT INTO "rule" (id, title, description, active, cloned, created_at, updated_at) VALUES
	('00c278b1-b6bf-4ca6-a275-9f43b60b4ddb', 'NR-12', 'Norma Regulamentadora número 12', true, false, now(), now()),
	('7ca6a5a0-589c-4a8b-87a2-246a897e36be', 'CLT', 'Consolidação das Leis do Trabalho', true, false, now(), now()),
	('dc4ccc56-0532-4393-a34b-399b3a2d01f0', 'NR-05', 'Norma Reguladora que trata de fornos e fogões', true, false, now(), now());
...
INSERT INTO item (id, rule_id, title, description, position_index, active, cloned, created_at, updated_at) VALUES
	('a1e05cec-ad23-4e91-83f6-8745d078a2cf', '00c278b1-b6bf-4ca6-a275-9f43b60b4ddb', '12.3.', 'O empregador deve adotar medidas de proteção para o trabalho em máquinas e equipamentos, capazes de garantir a saúde e a integridade física dos trabalhadores, e medidas apropriadas sempre que houver pessoas com deficiência envolvidas direta ou indiretamente no trabalho.', 0, true, false, now(), now()),
	('a90f5ca5-8309-49fd-87f6-9360fbbbb8d4', '00c278b1-b6bf-4ca6-a275-9f43b60b4ddb', '12.6.', 'Nos locais de instalação de máquinas e equipamentos, as áreas de circulação devem ser devidamente demarcadas e em conformidade com as normas técnicas oficiais.', 1, true, false, now(), now()),
	('f75f90ea-256c-4e0c-ac16-7a81685a362a', '00c278b1-b6bf-4ca6-a275-9f43b60b4ddb', '12.6.2.', 'As áreas de circulação devem ser mantidas permanentemente desobstruídas.', 2, true, false, now(), now()),
	...
	('2058570a-b873-4505-bcca-d4424b271725', '00c278b1-b6bf-4ca6-a275-9f43b60b4ddb', '12.12.', 'Nas máquinas móveis que possuem rodízios, pelo menos dois deles devem possuir travas.', 4, true, false, now(), now()),
	('52269a2f-3d07-4922-800e-650fdead8d6d', '00c278b1-b6bf-4ca6-a275-9f43b60b4ddb', '12.20.1.', 'As máquinas e equipamentos devem possuir dispositivo protetor contra sobretensão quando a elevação da tensão puder ocasionar risco de acidentes.', 5, true, false, now(), now()),
	('ad6a42e0-869d-4e71-91f4-6afb686f4aad', '00c278b1-b6bf-4ca6-a275-9f43b60b4ddb', '12.30.', 'Nas máquinas e equipamentos cuja operação requeira a participação de mais de uma pessoa, o número de dispositivos de acionamento bimanual simultâneos deve corresponder ao número de operadores expostos aos perigos decorrentes de seu acionamento, de modo que o nível de proteção seja o mesmo para cada trabalhador.', 6, true, false, now(), now()),
	('4f7cf5ce-ec3c-4f25-a64d-464519604ca8', '00c278b1-b6bf-4ca6-a275-9f43b60b4ddb', '12.40.1.', 'Depois que um comando de parada tiver sido iniciado pelo sistema de segurança, a condição de parada deve ser mantida até que existam condições seguras para o rearme. (Inserido pela Portaria MTPS 509/2016)', 7, true, false, now(), now()),
	('a0a0b9fc-bb72-466e-8dff-609a7aeabb9d', '00c278b1-b6bf-4ca6-a275-9f43b60b4ddb', '12.41.', 'Para fins de aplicação desta Norma, considera-se proteção o elemento especificamente utilizado para prover segurança por meio de barreira física, podendo ser:', 8, true, false, now(), now()),
	('3f3af6b2-92d7-4480-9ce6-0f1dd02046e7', '00c278b1-b6bf-4ca6-a275-9f43b60b4ddb', '12.56.', 'As máquinas devem ser equipadas com um ou mais dispositivos de parada de emergência, por meio dos quais possam ser evitadas situações de perigo latentes e existentes.', 9, true, false, now(), now()),
	('8d34a7f9-eaeb-4beb-aafd-d8bc87b439be', '00c278b1-b6bf-4ca6-a275-9f43b60b4ddb', '12.56.1.', 'Os dispositivos de parada de emergência não devem ser utilizados como dispositivos de partida ou de acionamento.', 10, true, false, now(), now()),
	('3168c6fa-8d02-4fd8-a0dd-de4e7778ee37', '00c278b1-b6bf-4ca6-a275-9f43b60b4ddb', '12.57.', 'Os dispositivos de parada de emergência devem ser posicionados em locais de fácil acesso e visualização pelos operadores em seus postos de trabalho e por outras pessoas, e mantidos permanentemente desobstruídos.', 11, true, false, now(), now());
-- ITEM FROM CLT RULE
INSERT INTO item (id, rule_id, title, description, position_index, active, cloned, created_at, updated_at) VALUES
	('010be314-8dda-4a66-889a-b79221d701d2', '7ca6a5a0-589c-4a8b-87a2-246a897e36be', 'Art. 3º.', 'Considera-se empregado toda pessoa física que prestar serviços de natureza não eventual a empregador, sob a dependência deste e mediante salário.', 0, true, false, now(), now()),
	('4785e103-5745-4c28-8b6d-f82c12151916', '7ca6a5a0-589c-4a8b-87a2-246a897e36be', 'Art. 4º.', 'Considera-se como de serviço efetivo o período em que o empregado esteja à disposição do empregador, aguardando ou executando ordens, salvo disposição especial expressamente consignada.', 1, true, false, now(), now()),
	('f2967600-b92b-4cc8-a325-c5784bdd3523', '7ca6a5a0-589c-4a8b-87a2-246a897e36be', 'Art. 13.', 'A Carteira de Trabalho e Previdência Social é obrigatória para o exercício de qualquer emprego, inclusive de natureza rural, ainda que em caráter temporário, e para o exercício por conta própria de atividade profissional remunerada.', 2, true, false, now(), now()),
	('dab07f34-52e7-4e12-875e-f176ecfb0d1c', '7ca6a5a0-589c-4a8b-87a2-246a897e36be', 'Art. 29.', 'O empregador terá o prazo de 5 (cinco) dias úteis para anotar na CTPS, em relação aos trabalhadores que admitir, a data de admissão, a remuneração e as condições especiais, se houver, facultada a adoção de sistema manual, mecânico ou eletrônico, conforme instruções a serem expedidas pelo Ministério da Economia.', 3, true, false, now(), now()),
	('34d9a053-fbdb-40b7-8282-4ec62ca1c6e2', '7ca6a5a0-589c-4a8b-87a2-246a897e36be', 'Art. 41.', 'Em todas as atividades será obrigatório para o empregador o registro dos respectivos trabalhadores, podendo ser adotados livros, fichas ou sistema eletrônico, conforme instruções a serem expedidas pelo Ministério do Trabalho.', 4, true, false, now(), now()),
	('68cc628f-8f9d-4536-ae61-5222a016a479', '7ca6a5a0-589c-4a8b-87a2-246a897e36be', 'Art. 59.', 'A duração diária do trabalho poderá ser acrescida de horas extras, em número não excedente de duas, por acordo individual, convenção coletiva ou acordo coletivo de trabalho. (Redação dada pela Lei nº 13.467, de 2017)', 5, true, false, now(), now()),
	('90de60fb-76f6-4b8c-a645-2aa243546f59', '7ca6a5a0-589c-4a8b-87a2-246a897e36be', 'Art. 60.', 'Nas atividades insalubres, assim consideradas as constantes dos quadros mencionados no capítulo "Da Segurança e da Medicina do Trabalho", ou que neles venham a ser incluídas por ato do Ministro do Trabalho, Industria e Comercio, quaisquer prorrogações só poderão ser acordadas mediante licença prévia das autoridades competentes em matéria de higiene do trabalho, as quais, para esse efeito, procederão aos necessários exames locais e à verificação dos métodos e processos de trabalho, quer diretamente, quer por intermédio de autoridades sanitárias federais, estaduais e municipais, com quem entrarão em entendimento para tal fim.', 6, true, false, now(), now()),
	('5d402252-a374-49db-af9c-01ee8e7c1183', '7ca6a5a0-589c-4a8b-87a2-246a897e36be', 'Art. 61.', 'Ocorrendo necessidade imperiosa, poderá a duração do trabalho exceder do limite legal ou convencionado, seja para fazer face a motivo de força maior, seja para atender à realização ou conclusão de serviços inadiáveis ou cuja inexecução possa acarretar prejuízo manifesto.', 7, true, false, now(), now()),
	('702b0579-d222-459a-8ce6-946c15e041df', '7ca6a5a0-589c-4a8b-87a2-246a897e36be', 'Art. 61. § 2º', 'Nos casos de excesso de horário por motivo de força maior, a remuneração da hora excedente não será inferior à da hora normal. Nos demais casos de excesso previstos neste artigo, a remuneração será, pelo menos, 25% (vinte e cinco por cento) superior à da hora normal, e o trabalho não poderá exceder de 12 (doze) horas, desde que a lei não fixe expressamente outro limite.', 8, true, false, now(), now()),
	('4189e41b-b11a-4c47-b9b7-f896fa1ef959', '7ca6a5a0-589c-4a8b-87a2-246a897e36be', 'Art. 66.', 'Entre 2 (duas) jornadas de trabalho haverá um período mínimo de 11 (onze) horas consecutivas para descanso.', 9, true, false, now(), now()),
	('5ba5f62a-7357-462f-a5a7-f8a3e75b5034', '7ca6a5a0-589c-4a8b-87a2-246a897e36be', 'Art. 67.', 'Será assegurado a todo empregado um descanso semanal de 24 (vinte e quatro) horas consecutivas, o qual, salvo motivo de conveniência pública ou necessidade imperiosa do serviço, deverá coincidir com o domingo, no todo ou em parte.', 10, true, false, now(), now()),
	('76106177-cfa2-418b-9c3a-e8738ce5b926', '7ca6a5a0-589c-4a8b-87a2-246a897e36be', 'Art. 68.', 'O trabalho em domingo, seja total ou parcial, na forma do art. 67, será sempre subordinado à permissão prévia da autoridade competente em matéria de trabalho.', 11, true, false, now(), now()),
	('b4601c16-26fd-4870-bc1e-134d47b799bf', '7ca6a5a0-589c-4a8b-87a2-246a897e36be', 'Art. 69.', 'Na regulamentação do funcionamento de atividades sujeitas ao regime deste Capítulo, os municípios atenderão aos preceitos nele estabelecidos, e as regras que venham a fixar não poderão contrariar tais preceitos nem as instruções que, para seu cumprimento, forem expedidas pelas autoridades competentes em matéria de trabalho.', 12, true, false, now(), now()),
	('10df2a25-715f-4574-a791-6981de794eb9', '7ca6a5a0-589c-4a8b-87a2-246a897e36be', 'Art. 70.', 'Salvo o disposto nos artigos 68 e 69, é vedado o trabalho em dias feriados nacionais e feriados religiosos, nos têrmos da legislação própria.', 13, true, false, now(), now()),
	('615c727a-3724-4f27-957e-43a79879d6d1', '7ca6a5a0-589c-4a8b-87a2-246a897e36be', 'Art. 71.', 'Em qualquer trabalho contínuo, cuja duração exceda de 6 (seis) horas, é obrigatória a concessão de um intervalo para repouso ou alimentação, o qual será, no mínimo, de 1 (uma) hora e, salvo acordo escrito ou contrato coletivo em contrário, não poderá exceder de 2 (duas) horas.', 14, true, false, now(), now()),
	('0c34af5d-fafc-4a0f-8126-808395b36bda', '7ca6a5a0-589c-4a8b-87a2-246a897e36be', 'Art. 73.', 'Salvo nos casos de revezamento semanal ou quinzenal, o trabalho noturno terá remuneração superior a do diurno e, para esse efeito, sua remuneração terá um acréscimo de 20 % (vinte por cento), pelo menos, sobre a hora diurna.', 15, true, false, now(), now()),
	('30180d5d-abf8-4e98-bf92-8cd0cc438508', '7ca6a5a0-589c-4a8b-87a2-246a897e36be', 'Art. 74.', 'O horário de trabalho será anotado em registro de empregados.', 16, true, false, now(), now()),
	('9810486b-f832-4f05-975a-0fd6e4b1aa7e', '7ca6a5a0-589c-4a8b-87a2-246a897e36be', 'Art. 75-C.', 'A prestação de serviços na modalidade de teletrabalho deverá constar expressamente do contrato individual de trabalho, que especificará as atividades que serão realizadas pelo empregado.', 17, true, false, now(), now()),
	('6ce2eaa7-918f-482b-bd8a-6e1fff8f57b5', '7ca6a5a0-589c-4a8b-87a2-246a897e36be', 'Art. 75-D.', 'As disposições relativas à responsabilidade pela aquisição, manutenção ou fornecimento dos equipamentos tecnológicos e da infraestrutura necessária e adequada à prestação do trabalho remoto, bem como ao reembolso de despesas arcadas pelo empregado, serão previstas em contrato escrito.', 18, true, false, now(), now()),
	('b3ddea9b-08c5-46c2-82fe-2a7ae7ab75ed', '7ca6a5a0-589c-4a8b-87a2-246a897e36be', 'Art. 75-E.', 'O empregador deverá instruir os empregados, de maneira expressa e ostensiva, quanto às precauções a tomar a fim de evitar doenças e acidentes de trabalho.', 19, true, false, now(), now()),
	('83e1c3e5-0771-48db-afd0-000f269e58cd', '7ca6a5a0-589c-4a8b-87a2-246a897e36be', 'Art. 130.', 'Após cada período de 12 (doze) meses de vigência do contrato de trabalho, o empregado terá direito a férias.', 20, true, false, now(), now()),
	('d11d6fef-de06-409a-9a03-328ac7816319', '7ca6a5a0-589c-4a8b-87a2-246a897e36be', 'Art. 137.', 'Sempre que as férias forem concedidas após o prazo de que trata o art. 134, o empregador pagará em dobro a respectiva remuneração.', 21, true, false, now(), now()),
	('7cd6e1e0-81a7-488f-904c-4b44dcccc2c1', '7ca6a5a0-589c-4a8b-87a2-246a897e36be', 'Art. 142.', 'O empregado perceberá, durante as férias, a remuneração que lhe for devida na data da sua concessão.', 22, true, false, now(), now()),
	('270726f0-b5e1-4d70-a56c-26c2bbc52551', '7ca6a5a0-589c-4a8b-87a2-246a897e36be', 'Art. 143.', 'É facultado ao empregado converter 1/3 (um terço) do período de férias a que tiver direito em abono pecuniário, no valor da remuneração que lhe seria devida nos dias correspondentes.', 23, true, false, now(), now()),
	('7850130b-2885-4076-98ba-6415fe9b73fd', '7ca6a5a0-589c-4a8b-87a2-246a897e36be', 'Art. 146.', 'Na cessação do contrato de trabalho, qualquer que seja a sua causa, será devida ao empregado a remuneração simples ou em dobro, conforme o caso, correspondente ao período de férias cujo direito tenha adquirido.', 24, true, false, now(), now()),
	('868b6b86-e790-4bbf-9b29-358b2d60900f', '7ca6a5a0-589c-4a8b-87a2-246a897e36be', 'Art. 147.', 'O empregado que for despedido sem justa causa, ou cujo contrato de trabalho se extinguir em prazo predeterminado, antes de completar 12 (doze) meses de serviço, terá direito à remuneração relativa ao período incompleto de férias, de conformidade com o disposto no artigo anterior.', 25, true, false, now(), now());
-- ITEM FROM NR-05 RULE
INSERT INTO item (id, rule_id, title, description, position_index, active, cloned, created_at, updated_at) VALUES
	('33596276-35a3-4980-adc2-06febc10a229', 'dc4ccc56-0532-4393-a34b-399b3a2d01f0', '5.7', 'O mandato dos membros eleitos da CIPA terá a duração de um ano, permitida uma reeleição.', 0, true, false, now(), now()),
	...
	('584f7c24-24c6-4881-95bb-63a722b65718', 'dc4ccc56-0532-4393-a34b-399b3a2d01f0', '5.11', 'O empregador designará entre seus representantes o Presidente da CIPA, e os representantes dos empregados escolherão entre os titulares o vice-presidente.', 2, true, false, now(), now()),
	('838efdb0-26fb-42b8-b55e-107fde7a9bb0', 'dc4ccc56-0532-4393-a34b-399b3a2d01f0', '5.24', 'As reuniões ordinárias da CIPA serão realizadas durante o expediente normal da empresa e em local apropriado.', 3, true, false, now(), now()),
	('52e34386-2a2f-4a76-bf5a-325946d4a2d1', 'dc4ccc56-0532-4393-a34b-399b3a2d01f0', '5.25', 'As reuniões da CIPA terão atas assinadas pelos presentes com encaminhamento de cópias para todos os membros.', 4, true, false, now(), now()),
	('719b4bd3-7b9c-4c6c-80fa-1c157fe396c6', 'dc4ccc56-0532-4393-a34b-399b3a2d01f0', '5.26', 'As atas devem ficar no estabelecimento à disposição da fiscalização do Ministério do Trabalho e Emprego.', 5, true, false, now(), now()),
	('ebca63b8-12e9-4df4-b4e2-c6363df801b1', 'dc4ccc56-0532-4393-a34b-399b3a2d01f0', '5.32', 'A empresa deverá promover treinamento para os membros da CIPA, titulares e suplentes, antes da posse.', 6, true, false, now(), now());
...
-- ATTACHMENT
INSERT INTO attachment (id, "data", file_name, file_type, created_at, updated_at) VALUES
    ('13e207ce-8e78-41eb-aeb8-bd28224f71c2', 26615, 'cat.jpg', 'image/jpeg', now(), now()),
    ('f5897b44-2b13-43b9-831b-24fd3bc0b66a', 27108, 'cortador-de-frios.webp', 'image/webp', now(), now()),
    ('282d1272-1f07-4f1f-9804-fac5fd593de9', 27109, 'forno.jpg', 'image/jpeg', now(), now()),
    ('82ca967b-22c1-456f-8a42-c9e5a4425244', 27110, 'expositor-de-vidro.jpg', 'image/jpeg', now(), now()),
    ('36043649-ff4f-4996-87f3-f800bbd7a9a6', 27111, 'carteira-de-trabalho.jpg', 'image/jpeg', now(), now()),
    ('55d6aa35-856b-4c93-bb2a-be2a1857e648', 27112, 'forno-pizza.jpg',	'image/jpeg', now(), now()),
    ('ac905081-da1e-4061-8c4f-2cdb8c3271b8', 27113, 'boring-cat.jpg', 'image/jpeg', now(), now());

INSERT INTO file (id, topic_id, attachment_id, active, note, position_index, created_at, updated_at) VALUES
    ('6f721b7a-6677-4e60-bfa9-7622e2ae963e', '2458dd1b-ff5d-43a7-907f-40667a627807', '13e207ce-8e78-41eb-aeb8-bd28224f71c2', true, '', 0, now(), now()),
    ('84576aee-686d-4dee-b020-d10623eff273', '2458dd1b-ff5d-43a7-907f-40667a627807', 'f5897b44-2b13-43b9-831b-24fd3bc0b66a', true, '', 2, now(), now()),
    ('7b44ef32-53b5-4049-af09-a4950ee4eedc', '2458dd1b-ff5d-43a7-907f-40667a627807', '282d1272-1f07-4f1f-9804-fac5fd593de9', true, '', 3, now(), now()),
    ('9aa8131a-1925-4a30-87eb-6b0e2acac63c', '728a4e77-2749-47be-a222-4e259c3812b0', '82ca967b-22c1-456f-8a42-c9e5a4425244', true, '', 0, now(), now()),
    ('fcc4595d-f923-4c18-a9e2-dbcdcaa13b68', '728a4e77-2749-47be-a222-4e259c3812b0', '36043649-ff4f-4996-87f3-f800bbd7a9a6', true, '', 1, now(), now()),
    ('090f8ef2-78e8-4171-8ca5-bf19724dde82', '728a4e77-2749-47be-a222-4e259c3812b0', '55d6aa35-856b-4c93-bb2a-be2a1857e648', true, '', 2, now(), now()),
    ('6772912e-f9d0-4826-aae1-12b81163c22b', '728a4e77-2749-47be-a222-4e259c3812b0', 'ac905081-da1e-4061-8c4f-2cdb8c3271b8', true, '', 3, now(), now());
